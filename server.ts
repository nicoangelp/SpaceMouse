...
// Built-in Knowledge Base Engine for hardware & CAD answers
function generateLocalHardwareAdvice(prompt: string, context?: any): string {
...
- **Decoupling Capacitors:** Place a **0.1µF (100nF) ceramic capacitor** across $V_{CC}$ and $GND$ close to each sensor group to suppress switching noise.
...
3. **Battery Fuel Gauge:**
  ...
  // General DIY SpaceMouse assistance
