...
export const LedRingCustomizerTab: React.FC<LedRingCustomizerTabProps> = ({
 ...
 <TooltipLabel label="24-NeoPixel LED Ring Studio & Orientation Alignment
 " tooltip="Software-rotate the LED ring so LED 1 aligns with your physical housing mount, tune color schemes, and calibrate speeds from slow crawl to blur.
 ...
 <div className="p-6 rounded-3xl neo-panel backdrop-blur-xl border border-transparent flex flex-col items-center justify-center space-y-5">
 {/* Canvas Simulator with Generous Top Padding to prevent any cut off */}
 <div className="relative w-full aspect-square max-w-[340px] neo-panel-inset rounded-2xl border border-transparent p-2 flex items-center justify-center shadow-inner">
 <canvas
 ref={canvasRef}
 width={340}
 height={340}
 ...
 <div className="w-full p-4 rounded-xl neo-panel-inset border border-transparent space-y-3">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-1.5">
 <RotateCw className="w-4 h-4 text-blue-400" />
 <span className="text-xs font-semibold text-white">Mounting Rotation Alignment</span>
 </div>
 ...
 <span className="">{ledRing.rotationOffsetDeg}°</span>
 </div>
 <Slider  
 min="0"
 max="345"
 ...
 : 'neo-panel backdrop-blur-xl text-zinc-400 hover:text-white border border-transparent'
 }`}
 >
 {deg}°
 </button>
 ...
 className="p-2.5 rounded-xl neo-panel-inset border border-transparent hover:border-transparent text-left transition flex items-center justify-between group"
 >
 <div className="space-y-1">
 <span className="text-xs font-semibold text-white block group-hover:text-blue-400 transition">
 {preset.name}
 </span>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-transparent">
 <div className="space-y-1.5">
 <label className="text-xs font-semibold text-zinc-300">Primary Color (Idle & Profile)</label>
 <div className="flex items-center gap-2 neo-panel-inset p-2 rounded-xl border border-transparent">
 <input
 type="color"
 ...
 value={ledRing.primaryColor}
 onChange={(e) => handleUpdate({ primaryColor: e.target.value })}
 className="bg-transparent text-xs text-white focus:outline-none uppercase w-full"
 />
 </div>
 </div>
 ...
 <TooltipLabel label="Master Ring Brightness" tooltip="Sets the global brightness limit for the entire NeoPixel array. Lower this to save battery." className="font-semibold text-zinc-300" />
 <span className=" font-semibold text-blue-400">{ledRing.brightness}%</span>
 </div>
 <Slider  
 min="0"
 max="100"
 ...
 <div className="space-y-2 pt-2 border-t border-transparent">
 <div className="flex items-center justify-between text-xs">
 <TooltipLabel label="Animation Speed" tooltip="Controls the update frequency of the NeoPixel patterns in the 60FPS loop." className="font-semibold text-zinc-300" />
 <span className=" font-semibold text-blue-400">Level {ledRing.idleSpeed}/10</span>
 </div>
 <Slider  
 min="1"
 max="10"
 ...
 ? 'bg-cyan-950/40 border-blue-500 shadow-sm'
 ...
 <span className="text-xs text-zinc-400 block mt-0.5">{opt.desc}</span>
 </button>
 ))}
 </div>
 </div>
