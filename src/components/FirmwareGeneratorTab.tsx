...
import { FirmwareConfig, Profile, Esp32Chip, SensorArchitecture, FirmwareMode, CalibrationData } from '../types';
...
export const FirmwareGeneratorTab: React.FC<FirmwareGeneratorTabProps> = ({ profile, allProfiles, calibrationData }) => {
 ...
 const generatedCpp = generateEsp32Firmware(config, profile, allProfiles, calibrationData);
 ...
 className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#050608] hover:border-slate-700 text-zinc-200 text-xs font-semibold border border-[#1e2632] transition-all"
 >
 ...
 <label className="text-xs font-semibold text-zinc-300 ">Target Microcontroller</label>
 <select
 value={config.chip}
 onChange={(e) => {
 ...
 className="w-full px-3 py-2 bg-[#050608] border border-[#1e2632] rounded-lg text-xs text-white focus:outline-none focus:border-blue-500 "
 >
 ...
 {/* Sensor Architecture */}
 <div className="space-y-1.5">
 <label className="text-xs font-semibold text-zinc-300 ">Sensor Hardware Type</label>
 <select
 ...
 <div className="space-y-1.5">
 <label className="text-xs font-semibold text-zinc-300 ">Emulation Protocol</label>
 <select
 ...
 viewFile === 'cpp'
 ? 'bg-cyan-950/80 border border-blue-500 text-blue-400 glow-cyan-sm'
 ...
 className="flex items-center gap-1.5 px-2.5 py-1 rounded bg-[#050608] border border-[#1e2632] hover:border-slate-700 text-zinc-200 text-xs font-semibold transition-all"
 >
 ...
 {/* Code Viewport */}
 {viewFile === 'cpp' && (
 <div className="p-4 max-h-[500px] overflow-y-auto text-xs text-zinc-300 leading-relaxed bg-[#050608] select-text">
 ...
 {viewFile === 'wiring' && (
 <div className="p-6 space-y-6 bg-[#050608] text-xs text-zinc-300">
 ...
 <div className="p-4 rounded-xl bg-[#0a0d12] border border-blue-500/40 space-y-2">
 <h4 className="font-semibold text-blue-400 ">1. MPU-6050 6-Axis IMU (I2C)</h4>
 ...
 <div className="p-4 rounded-xl bg-[#0a0d12] border border-green-300 space-y-2">
 <h4 className="font-semibold text-blue-400 ">2. Treedix 9-Key Mechanical Keypad</h4>
 <ul className="list-disc list-inside space-y-1 text-zinc-300 text-xs ">
 <li>Keys 1-9 to GPIOs: <strong className="text-blue-400">13, 12, 14, 27, 26, 25, 33, 32, 4</strong>.</li>
 ...
 <div className="p-4 rounded-xl bg-[#0a0d12] border border-blue-500/40 space-y-2">
 <h4 className="font-semibold text-blue-400 ">3. Adafruit 24 RGB NeoPixel Ring</h4>
 <ul className="list-disc list-inside space-y-1 text-zinc-300 text-xs ">
 ...
 <h4 className="font-semibold text-blue-400 ">4. TP4056 + 4200mAh LiPo Power</h4>
 <ul className="list-disc list-inside space-y-1 text-zinc-300 text-xs ">
