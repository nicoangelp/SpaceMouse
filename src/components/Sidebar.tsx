...
export const Sidebar: React.FC<SidebarProps> = ({
 ...
 onConnectSerial, onDisconnect, packetHz, onSyncAll
}) => {
 ...
 { id: 'profiles', label: 'Profiles & Sync', icon: Layers },
 ];
 ...
 >
 <Sparkles className={`w-4 h-4 ${isSyncing ? 'animate-bounce text-yellow-300' : 'text-white'}`} />
