...
export const ProfileManagerModal: React.FC<ProfileManagerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-3xl bg-[#080c14] border border-cyan-500/40 rounded-2xl shadow-2xl overflow-hidden max-h-[92vh] flex flex-col font-mono">
        {/* Header */}
        <div className="p-4 sm:p-5 bg-gradient-to-r from-[#0d1524] via-[#080c14] to-[#0d1524] border-b border-[#1e2632] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-cyan-950/80 border border-cyan-500/50 text-cyan-300 shadow-lg shadow-cyan-500/20">
              <Layers className="w-6 h-6" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-bold text-white">Custom Profile & Hardware Flash Studio</h2>
        ...
        <div className="p-4 bg-[#05070d] border-b border-[#1e2632] flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-500 disabled:opacity-40 disabled:cursor-not-allowed text-black font-bold transition shadow-md shadow-cyan-600/20 active:scale-95"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-gradient-to-r from-amber-600 to-rose-600 hover:from-amber-500 hover:to-rose-500 disabled:opacity-50 text-white font-bold transition shadow-lg shadow-rose-900/30"
            ...
            <button
              ...
              disabled={isBurningNvs || !hardwareConnection.isConnected}
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 disabled:opacity-50 text-white font-bold transition shadow-lg shadow-cyan-900/30"
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-2 rounded-lg bg-rose-950/40 hover:bg-rose-900/60 text-rose-300 border border-rose-500/30 transition disabled:opacity-30"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-2 rounded-lg bg-[#0c121e] hover:bg-slate-800 text-slate-300 hover:text-white border border-[#1e2632] transition"
        ...
        <div className="p-4 sm:p-5 overflow-y-auto space-y-4 flex-1 custom-scrollbar">
          ...
          {isCreatingNew && (
            <form
              ...
              className="p-4 rounded-xl bg-[#0d1524] border border-cyan-500/50 shadow-xl space-y-3.5 animate-fadeIn"
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="space-y-1.5">
                  <label className="text-[10px] text-slate-400 block font-bold">PROFILE NAME</label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] text-slate-400 block font-bold">BASE CAD SUITE TEMPLATE</label>
                  <select
              ...
              <div className="flex items-center justify-end gap-2 pt-1">
                ...
                <button
                  type="submit"
                  className="px-4 py-1.5 rounded-lg bg-cyan-600 hover:bg-cyan-500 text-black font-bold text-xs flex items-center gap-1.5"
                >
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-2 mb-2">
                        ...
                        {isEditing ? (
                          <div className="flex items-center gap-1.5 flex-1">
                            <input
                              ...
                              className="w-full px-2 py-1 bg-black border border-cyan-500 rounded text-xs text-white focus:outline-none"
                              autoFocus
                            />
                            <button
                          ...
                          <div className="min-w-0">
                            <h3 className="text-xs font-bold text-white truncate flex items-center gap-2 font-sans">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        <button
                          ...
                          className="p-1 rounded text-slate-500 hover:text-rose-400 hover:bg-rose-950/40 disabled:opacity-30"
                    ...
                    <div className="grid grid-cols-3 gap-1.5 py-2 my-1 border-t border-b border-[#1e2632]/60 text-[10px] text-slate-400">
                      <div>
                        <span className="text-slate-500 block">X/Y SENS:</span>
                        <span className="text-slate-200 font-semibold">{profile.axes.x.sensitivity}x</span>
                      </div>
                      <div>
                        <span className="text-slate-500 block">SMOOTHING:</span>
                        <span className="text-slate-200 font-semibold">{profile.filters.smoothingAlpha}</span>
                      </div>
                      <div>
                        <span className="text-slate-500 block">LED MODE:</span>
                  ...
                  <div className="flex items-center justify-between gap-2 mt-3 pt-1">
                    {!isActive ? (
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-cyan-900/60 hover:text-cyan-300 text-slate-300 text-xs font-semibold transition"
                      >
                        Activate Profile
                      </button>
                    ) : (
                    ...
                    <button
                      ...
                      disabled={isBurningNvs || !hardwareConnection.isConnected}
                      className="px-2.5 py-1.5 rounded-lg bg-amber-950/80 hover:bg-amber-900 border border-amber-500/40 text-amber-300 text-[11px] font-semibold flex items-center gap-1 transition disabled:opacity-40"
        ...
        <div className="p-4 bg-[#05070d] border-t border-[#1e2632] flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2 text-slate-400">
            ...
            <span>
              ...
              <strong className={hardwareConnection.isConnected ? 'text-emerald-400' : 'text-slate-500'}>
          ...
          <button
            onClick={onClose}
            className="px-5 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-500 text-black font-bold transition shadow-md shadow-cyan-600/20"
          >
            Done
          </button>
        </div>
